...
class gw_functions
{
     ...
     */
    public function text_make_uid($maxchar = 8, $nChar = 0, $first = '')
    {
        /* Exclude bad symbols. */
     ...
     */
    public function number_format($int, $dec = 0, $ar = array('decimal_separator'=> '.', 'thousands_separator'=> ' '))
    {
        return str_replace(
            ' ',
            '&#160;',
     ...
     */
    public function text_utf2hex($t, $is_x = 1)
    {
        $str = '';
        $len = strlen($t);
        for ($i = 0; $i < $len; $i++) {
     ...
     * @see mb_strlen()
     */
    public function getFormHeight($v, $int_max = 25)
    {
        preg_match_all("/\n/", $v, $vLines);
    ...
    /* */
    public function date_gmusertime($int_time_server, $user_offset)
    {
    ...
    */
    public function date_get_passed_y($time_unix, $y, $m, $d)
    {
     ...
     */
    public function date_get_localtime($gmt_offset, $is_use_dst = 1)
    {
        $r = $gmt_offset * 3600;
        if ($is_use_dst) {
            $r += 3600;
     ...
     */
    public function date_Ts14toTime($t)
    {
     ...
     */
    public function date_SecToTime($totalsec)
    {
     ...
     * @return string
     */
    public function mb_substr($t, $start = 0, $end = 0, $encoding = 'UTF-8')
    {
        /* --enable-mbstring */
     ...
     */
    public function mb_strpos($t, $s, $encoding = 'UTF-8')
    {
        /* --enable-mbstring */
     ...
     */
    public function is_detect_utf8($t)
    {
        /* --enable-mbstring */
    ...
    public function gw_numeric2character($t)
    {
    ...
    public function gw_character2numeric($t)
    {
     ...
     */
    public function gwConvertCharset($str, $from, $to)
    {
    ...
    /* */
    public function math_hexdec($ar)
    {
        foreach ($ar as $k => $v) {
            $ar[$k] = hexdec($v);
        }
    ...
    /* Inverts color */
    public function math_hex2negative($t)
    {
     ...
     * PHP 5 CVS only
     */
    public function str_split($t, $length = 1)
    {
