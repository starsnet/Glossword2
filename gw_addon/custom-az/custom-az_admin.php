...
class gw_addon_custom_az_admin extends gw_addon
{
     ...
     */
    public function get_form_custom_az($vars, $runtime = 0, $ar_broken = array(), $ar_req = array())
    {
        $str_hidden = '';
        $str_form = '';
        $v_class_1 = 'td1';
    ...
    /* */
    public function get_form_import($vars, $runtime = 0, $ar_broken = array(), $ar_req = array())
    {
        $oForm = new gwForms();
    ...
    /* */
    public function get_form_export($vars, $runtime = 0, $ar_broken = array(), $ar_req = array())
    {
        $oForm = new gwForms();
