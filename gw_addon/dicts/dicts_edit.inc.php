...
else
{
    ...
    if ($this->gw_this['vars']['remove']) {
        ...
        $oConfirm->setQuestion(
            '<p class="xr"><span class="red"><strong>'.  $this->oL->m('9_remove') .
    ...
    if (!$isPostError) /* Final update */
    {
        ...
        $q['date_created'] = @mktime(
            $tmp['ar_created_his'][0], $tmp['ar_created_his'][1], $tmp['ar_created_his'][2],
