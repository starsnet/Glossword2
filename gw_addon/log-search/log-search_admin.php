...
class gw_addon_log_search_admin extends gw_addon
{
    ...
    /* */
    public function get_menu_period()
    {
        /* the list of time periods */
        return '<div class="actions-secondary"><span>'.$this->oL->m('period').':</span> '.
        $this->oHtml->a(
            $this->sys['page_admin'].'?'. GW_ACTION.'='.GW_A_BROWSE.'&'. GW_TARGET.'='.$this->addon_name.'&'.
    ...
    /* */
    public function get_menu_reports()
    {
    ...
    public function browse()
    {
        ...
        $sql_where = sprintf(
            ' sr.date_created < %d AND sr.date_created > %d',
    ...
    /* */
    public function _print_report($arSql)
    {
        global $strR;
        $str_pages = getNavToolbar(
            $this->int_pages,
