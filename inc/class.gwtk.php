...
if (!defined('IS_CLASS_GWTK')) {
    ...
    class gwtk
    {
        public $pathHomeDir = 'locale';
        public $pathLocale  = 'en';
        public $pathFile    = 'global';
        public $pathEx      = 'php';
        public $pathRoot    = '.';
        public $varMode     = 'names'; /* [ names | constants ], `names' is default */
         ...
         */
        public function getCustom($f_name, $localename, $mode = 'join')
        {
